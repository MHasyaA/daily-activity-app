    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-tr from-slate-900 via-slate-800 to-rose-950 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-8 transform transition-all animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          <div className="p-3 bg-rose-500 rounded-2xl text-white shadow-lg shadow-rose-500/20 mb-3.5">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-11 pr-4 py-3 bg-white/5 border border-white/10 focus:border-rose-500 focus:bg-white/10 rounded-2xl text-sm font-medium text-white placeholder-slate-500 outline-none transition-all"
              />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-rose-500 hover:bg-rose-600 disabled:bg-rose-500/50 text-white text-sm font-bold rounded-2xl shadow-lg shadow-rose-500/25 transition-all flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
